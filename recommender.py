...
def process_quantum_recommendations(
    ...
    if artifact:
        ...
        # Temporary fit for un-trained state
        from preprocessing import fit_preprocessing_pipeline
    ...
    # Rank candidate movies strictly by Hybrid Score S_H descending
